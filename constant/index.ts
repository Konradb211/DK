...
export const navLinks: Links[] = [
  ...
  { href: "/our-work", title: "Realizacje" },
  { href: "/#FAQ", title: "FAQ" },
...
export const services: Services[] = [
  {
    ...
    src: "/images/mobileWebsite.svg",
    alt: "Komputer z projektem strony internetowej",
    links: "websites",
  },
  {
    ...
    src: "/images/mobileGraphics.svg",
    alt: "Tablet z projektem graficznym",
    links: "graphics-projects",
  },
  {
    ...
    src: "/images/mobileWebApps.svg",
    alt: "Smartfon z aplikacją webową",
    links: "web-apps",
  },
  {
    ...
    src: "/images/mobileShowcase.svg",
    alt: "Laptop z wykresami, symbolizujący konfigurację wizytówki Google",
    links: "showcase",
  },
];
...
export const sitemap: Sitemap[] = [
  { text: "Strony internetowe", href: "websites" },
  { text: "Projekty graficzne", href: "graphics-projects" },
  { text: "Aplikacje webowe", href: "web-apps" },
  { text: "Konfiguracja wizytówki Google", href: "showcase" },
  { text: "Realizacje", href: "/our-work" },
  { text: "Współpraca", href: "/#Kontakt" },
...
export const RealizationPhotos = [
  {
    whitePhotos: [
      { src: "/images/headerLaptopMini.png", alt: "kolbasa" },
      { src: "/images/headerLaptopMini.png", alt: "kolbasa" },
